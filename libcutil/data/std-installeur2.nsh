...
Section "${DESCRIPTIF}" SecCkernide
  SetOutPath "$INSTDIR"
...
!ifndef MODE_PATCH
  ...
  File /r "c:\msys32\mingw32\share\icons\*"
...
!endif
  ...
  SetOutPath "$INSTDIR"
!ifndef MODE_PATCH
  File "c:\ocv320\build\install\x86\mingw\bin\*.dll"
  File "C:\msys32\mingw32\bin\*.dll"
...
!endif
  ...
  CreateShortCut "$DESKTOP\${DESCRIPTIF}.lnk" "$INSTDIR\${NOM_EXE}" "" "$INSTDIR\data\img\opencv.ico"
